...
\begin{theorem}[GCDChecker Complete]
    ...
    \uses{def:CheckerSound,def:CFGSentences,thm:GrammarSubsetCheckerLang,thm:CheckerLangSubsetGrammar, thm:PrefixSubsetIntermediate, thm:IntermediateSubsetPrefix}
